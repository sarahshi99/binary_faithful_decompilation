...
- Behavior labels: `{}`
- Cleaning status counts: `{'empty_output': 56}`
- Paired case count: `0`
...
- Records: `/home/shx/projects/binary_faithful_decompilation/analysis_outputs/decompile_faithfulness/phase7_llm_public_topup_full_cuda3_s1/records.jsonl`
