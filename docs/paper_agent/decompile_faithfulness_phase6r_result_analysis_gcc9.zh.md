...
- Static structured proxy AUC: `0.8424`
- Dynamic Trace v3 AUC: `1.0000`
- SOTA delta vs best non-oracle baseline: `0.1576`
- V3 behavior-preserving rewrite FP rate: `0.0000`
- Records: `/home/shx/projects/binary_faithful_decompilation/analysis_outputs/decompile_faithfulness/phase6r_ghidra_gcc9_full/records.jsonl`
